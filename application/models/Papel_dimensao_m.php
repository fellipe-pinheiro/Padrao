...
class Papel_dimensao_m extends CI_Model {
    ...
    var $column_order = array('id', 'altura', 'largura'); //set column field database for datatable orderable
    var $column_search = array('altura', 'largura'); //set column field database for datatable searchable just altura , largura are searchable
    ...
    public function get_by_id($id){
        ...
        $result =  $this->Papel_dimensao_m->_changeToObject($result->result_array());
        return $result[0];
    }
    ...
    public function get_list($id = '') {
        ...
        return $this->Papel_dimensao_m->_changeToObject($result->result_array());
    }

...
class Container_adicional_m extends CI_Model {
	...
	public function get_by_adicional_id($id,$tabela,$owner,$objeto){
		...
		if($result->num_rows() > 0){
			$result =  $this->Container_adicional_m->__changeToObject($result->result_array(),$owner,$objeto);
			return $result;
		}
		return false;
	}
	public function get_by_orcamento_convite($id){
		...
		if($result->num_rows() > 0){
			$result =  $this->Container_adicional_m->__changeToObject($result->result_array(),'convite',null);
			return $result;
		}
		return null;
	}
	...
	private function __changeToObject($result_db,$owner,$objeto) {
		$object_lista = array();

            ...
            <ul class="nav navbar-nav">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="<?= base_url('pedido/lista') ?>"><i class="fa fa-list-alt" aria-hidden="true"></i> Lista</a></li>
                    </ul>
                </li>
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li class=""><a href="<?= base_url('orcamento') ?>"><i class="fa fa-calculator" aria-hidden="true"></i> Orçamento</a></li>
                        <li class=""><a href="<?= base_url('orcamento/lista') ?>"><i class="fa fa-list-alt" aria-hidden="true"></i> Lista</a></li>
                    </ul>
                </li>
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a href="<?= base_url('convite_modelo') ?>"><i class="fa fa-envelope-o" aria-hidden="true"></i> Convite Modelo</a></li>
                        <li><a href="<?= base_url('personalizado_modelo') ?>"><i class="fa fa-paint-brush" aria-hidden="true"></i> Personalizado Modelo</a></li>
                        <li role="separator" class="divider"></li>
                        <li class="dropdown-header">Matéria prima</li>
                        <li><a href="<?= base_url('acabamento') ?>"><i class="glyphicon glyphicon-scissors"></i> Acabamento</a></li>
                        <li><a href="<?= base_url('acessorio') ?>"><i class="fa fa-diamond" aria-hidden="true"></i> Acessório</a></li>
                        <li><a href="<?= base_url('fita') ?>"><i class="glyphicon glyphicon-tag"></i> Fita</a></li>
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="<?= base_url('assessor') ?>"><i class="fa fa-user-secret" aria-hidden="true"></i> Assessor</a></li>
                        <li><a href="<?= base_url('cliente') ?>"><i class="fa fa-users" aria-hidden="true"></i> Cliente</a></li>
                        <li><a href="<?= base_url('evento') ?>"><i class="glyphicon glyphicon-edit"></i> Evento</a></li>
                        <li><a href="<?= base_url('forma_pagamento') ?>"><i class="fa fa-credit-card-alt" aria-hidden="true"></i> Formas de pagamento</a></li>
                        <li><a href="<?= base_url('loja') ?>"><i class="glyphicon glyphicon-home"></i> Loja</a></li>
                        <li><a href="<?= base_url('mao_obra') ?>"><i class="fa fa-hand-paper-o" aria-hidden="true"></i> Mão de obra</a></li>
                    </ul>
                </li>
                <li class="dropdown">

										...
										if(!empty($session_owner->container_papel)){
											foreach ($session_owner->container_papel as $key => $container_papel) {
												...
												<tr>
													...
													<td><?=$container_papel->papel->nome?> : <?=$container_papel->papel->get_selected_papel_gramatura()->gramatura?>g</td>

                ...
                <div class="modal-body">
                    <fieldset>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group input-padding">
                                    <label for="orc_id" class="control-label">Orçamento Nº</label>
                                    <input type="number" class="form-control" id="orc_id" placeholder="Orçamento Nº">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group input-padding">
                                <label for="data_orcamento" class="control-label">Data do orçamento</label>
                                    <input type="text" class="form-control datetimepicker" id="data_orcamento" placeholder="00/00/0000">
                                </div>
                            </div>
                        </div>
                        <br>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group input-padding">
                                    <label for="cli_nome" class="control-label">ID Cliente</label>
